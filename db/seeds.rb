...
attractions.each_with_index do |attraction,index|
  ...
  if index < 64
    result = attraction['photo_url'] || BingSearch.image(attraction['name']+' Bangkok', filters: [:square]).first
    if result.nil?
    ...
    result = attraction['photo_url'] || BingSearch.image(attraction['name']+' Beirut', filters: [:square]).first
    if result.nil?
      a.photo_url = "ADD ME MOFO"
    else
      a.photo_url = result.media_url
    ...
    result = attraction['photo_url'] || BingSearch.image(attraction['name']+' Budapest', filters: [:square]).first
    if result.nil?
      a.photo_url = "ADD ME MOFO"
    else
      a.photo_url = result.media_url
    ...
    result = attraction['photo_url'] || BingSearch.image(attraction['name']+' Cape Town', filters: [:square]).first
    if result.nil?
      a.photo_url = "ADD ME MOFO"
    else
      a.photo_url = result.media_url
    ...
    result = attraction['photo_url'] || BingSearch.image(attraction['name']+' Detroit', filters: [:square]).first
    if result.nil?
      a.photo_url = "ADD ME MOFO"
    else
      a.photo_url = result.media_url
    ...
    result = attraction['photo_url'] || BingSearch.image(attraction['name']+' Florence', filters: [:square]).first
    if result.nil?
      a.photo_url = "ADD ME MOFO"
    else
      a.photo_url = result.media_url
    ...
    result = attraction['photo_url'] || BingSearch.image(attraction['name']+' Istanbul', filters: [:square]).first
    if result.nil?
      a.photo_url = "ADD ME MOFO"
    else
      a.photo_url = result.media_url
    ...
    result = attraction['photo_url'] || BingSearch.image(attraction['name']+' Krakow', filters: [:square]).first
    if result.nil?
      a.photo_url = "ADD ME MOFO"
    else
      a.photo_url = result.media_url
    ...
    result = attraction['photo_url'] || BingSearch.image(attraction['name']+' Kyoto', filters: [:square]).first
    if result.nil?
      a.photo_url = "ADD ME MOFO"
    else
      a.photo_url = result.media_url
    ...
    result = attraction['photo_url'] || BingSearch.image(attraction['name']+' Paris', filters: [:square]).first
    if result.nil?
      a.photo_url = "ADD ME MOFO"
    else
      a.photo_url = result.media_url
    ...
    result = attraction['photo_url'] || BingSearch.image(attraction['name']+' Rio de Janeiro', filters: [:square]).first
    if result.nil?
      a.photo_url = "ADD ME MOFO"
    else
      a.photo_url = result.media_url
    ...
    result = attraction['photo_url'] || BingSearch.image(attraction['name']+' San Francisco', filters: [:square]).first
    if result.nil?
      a.photo_url = "ADD ME MOFO"
    else
      a.photo_url = result.media_url
    ...
    result = attraction['photo_url'] || BingSearch.image(attraction['name']+' Sydney', filters: [:square]).first
    if result.nil?
      a.photo_url = "ADD ME MOFO"
    else
      a.photo_url = result.media_url
...
#     i+=1
#   elsif i<20
#     result = attraction['photo_url'] || BingSearch.image(parsed1['results']['collection1'][i]['name']+' paris', filters: [:square]).first.media_url
